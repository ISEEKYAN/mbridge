...
class TransformerConfig(ModelParallelConfig):
    ...
    """Whether to use N-gram enhanced embedding. When True, uses NewNgramEmbedding instead of
    LanguageModelEmbedding."""

    oe_vocab_size_ratio: float = 78
    """Vocabulary size ratio for N-gram embedding. Used to calculate m = oe_vocab_size_ratio * vocab_size."""

    oe_split_num: int = 4
    """Split number k for N-gram embedding. Controls the number of parallel N-gram embedders."""

    oe_neighbor_num: int = 4
    """Neighbor number n for N-gram embedding. Controls the maximum N-gram order (2-gram to n-gram)."""

    pad_token_id: int = 3
    """Padding token ID for N-gram embedding vocabulary padding."""

    embP: int = 8
    """Padding value for N-gram embedding vocabulary size. Vocabulary size will be padded to be
    ...
    """Number of zero experts"""

    zero_expert_type: Optional[str] = None
    """Type of zero experts"""
