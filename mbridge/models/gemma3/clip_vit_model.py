...
# support sp from megatron/core/models/vision/clip_vit_model.py
...
class CLIPViTModel(VisionModule):
    ...
    def __init__(
        ...
        super(CLIPViTModel, self).__init__(config=transformer_config)
        ...
        extra_args = {}
        if mcore_version_ge_0_13:
            extra_args = {"dtype": transformer_config.params_dtype}
        self.position_embeddings = torch.nn.Embedding(
            self.seq_length, self.visual_hidden_size, **extra_args
        )
