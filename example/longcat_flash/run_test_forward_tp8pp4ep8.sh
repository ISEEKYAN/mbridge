...
# LongCat Flash 560B - MBridge Forward Pass Test
# Configuration: 32 GPUs (4 nodes x 8 GPUs), TP=8, PP=4, EP=8
# Test: Load weights, run forward pass, compare with HF reference output
...
echo "=========================================="
echo "MBridge Forward Test Configuration:"
...
# ==================== Step 1: Generate HF reference (rank 0 only) ====================
if [ "${NODE_RANK}" -eq 0 ]; then
...
echo ""
echo "=========================================="
echo "Forward test completed on Node ${NODE_RANK}!"
echo "=========================================="
