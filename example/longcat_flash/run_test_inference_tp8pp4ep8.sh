...
# LongCat Flash 560B - MBridge Inference (Generation) Test
# Configuration: 32 GPUs (4 nodes x 8 GPUs), TP=8, PP=4, EP=8
# Test: Load weights, run token-by-token generation
...
echo "=========================================="
echo "MBridge Inference Test Configuration:"
...
torchrun \
    ...
    mbridge/example/longcat_flash/load_model_and_inference.py \
...
echo ""
echo "=========================================="
echo "Inference test completed on Node ${NODE_RANK}!"
echo "=========================================="
